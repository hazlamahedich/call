...
test.describe('[P0] Authenticated User Flows - Story 1-2', () => {
  test.skip('E2E-AUTH-001][P0] should sign in as admin user', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-002][P0] should sign in as member user', async ({ page }) => {
...
test.describe('[P0] Role-Based Access Control - AC3', () => {
  test.skip('E2E-AUTH-003][P0] admin should see all UI elements', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-004][P0] member should see limited UI elements', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-005][P1] admin should be able to create organization', async ({ page }) => {
    // Given: Admin user is signed in
  ...
  test.skip('E2E-AUTH-006][P1] member should not be able to create organization', async ({ page }) => {
    // Given: Member user is signed in
...
test.describe('[P1] Organization Management - AC1', () => {
  test.skip('E2E-AUTH-007][P1] should create organization with metadata', async ({ page }) => {
    // Given: Admin user is signed in
  ...
  test.skip('E2E-AUTH-008][P2] should update organization settings', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-009][P2] should soft delete organization', async ({ page }) => {
    // Given: Admin user is signed in and organization exists
...
test.describe('[P1] Client Management - AC2', () => {
  test.skip('E2E-AUTH-010][P1] should create client under organization', async ({ page }) => {
    // Given: Admin user is signed in and organization exists
    // When: Admin creates client with name and settings
    // Then: Client should be stored in organization's publicMetadata.clients[]
    // TODO: Implement after Clerk test fixtures are available
  });

  test.skip('E2E-AUTH-011][P1] should update client settings', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-013][P1] member can only manage assigned clients', async ({ page }) => {
...
test.describe('[P1] Error Handling - AC6', () => {
  test.skip('E2E-AUTH-014][P1] should display Clerk unavailable error', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-015][P1] should handle session expiry gracefully', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-016][P1] should show 403 for unauthorized org access', async ({ page }) => {
...
test.describe('[P2] Session Persistence - AC5', () => {
  test.skip('E2E-AUTH-017][P2] should persist session across page refresh', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-018][P2] should persist organization context across navigation', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-019][P2] should maintain auth state in new tab', async ({ page, context }) => {
    // Given: User is signed in
...
test.describe('[P2] Multi-Organization Membership', () => {
  test.skip('E2E-AUTH-020][P2] should allow user to switch organizations', async ({ page }) => {
  ...
  test.skip('E2E-AUTH-021][P2] should maintain independent roles per organization', async ({ page }) => {
